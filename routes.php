...
*/
$route['default_controller'] = 'prompts';
$route['404_override'] = 'pages/not_found';
$route['translate_uri_dashes'] = FALSE;
/*Backend*/
$route['prompts/(:any)-p([A-Z0-9_-]+).html'] = 'prompts/detail/$2';
$route['category/(:any)'] = 'category/categor/$1';
$route['tag/(:any)'] = 'tag/index/$1';
$route['audiences/(:any)'] = 'audiences/index/$1';

$route['admin'] = 'prompts';
$route['dashboard'] = 'prompts';
$route['signup'] = 'backend/signup';
...
$route['api/audience/(:any)'] = '/backend/audienceApi/index/$1';
